    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-6xl mx-auto p-6">
          ...
          <div className="flex items-start justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="text-sm border border-[#333] hover:border-[#555] px-3 py-1.5 rounded-lg transition"
              >
                Refresh
              </button>
            </div>
          ...
          {status?.connected && status.profiles && status.profiles.length > 0 && (
            <div className="mt-4 flex items-center gap-4">
              ...
              <select
                ...
                className="bg-[#0a0a0a] border border-[#333] rounded-lg px-3 py-1.5 text-white text-sm focus:border-[#00e87b] focus:outline-none"
              >
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="bg-[#0a0a0a] border border-[#333] rounded-lg px-3 py-1.5 text-white text-sm focus:border-[#00e87b] focus:outline-none w-48"
                />
              </div>
            </div>
          )}
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="bg-[#111] border border-[#333] hover:border-[#555] text-white px-4 py-2 rounded-lg text-sm transition"
            >
        ...
        <div className="space-y-4">
          {calls.map((call, i) => (
            <div key={i} className="bg-[#111] border border-[#222] hover:border-[#333] rounded-xl p-5 transition">
              <div className="flex items-start justify-between mb-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="text-xs border border-[#333] hover:border-[#555] px-3 py-1.5 rounded-lg transition disabled:opacity-50"
                  >
              ...
              {call.script && (
                <div className="mt-3">
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full bg-[#0a0a0a] border border-[#222] rounded-lg px-3 py-2 text-gray-300 text-sm resize-none focus:border-[#00e87b] focus:outline-none"
                  />
                </div>
              )}
