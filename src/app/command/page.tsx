          ...
          <div className="space-y-6">
            ...
            <Card title="Quick Actions" icon={Zap} delay={500}>
              <div className="space-y-2 mt-4">
                ...
                <Link
                  href="/nexus"
                  className="block w-full text-center py-2.5 rounded-xl bg-[#1a1a1a] text-[#aaa] text-sm font-medium hover:bg-[#222] transition border border-[#222]"
                >
                  NEXUS Console →
                </Link>
              </div>
    ...
    <button
      ...
      className={`w-full py-2.5 rounded-xl text-sm font-medium transition border ${
        state === "done"
          ...
          : "bg-[#1a1a1a] border-[#222] text-[#aaa] hover:bg-[#222] hover:text-white"
      } disabled:opacity-50`}
    >
      {state === "loading" ? (
